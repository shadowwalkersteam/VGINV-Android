...
//            if (message.getText().contains("video") || message.getText().endsWith(".mp4") || message.getText().endsWith(".flv") || message.getText().endsWith(".mkv")) {
//                text.setText("Video " + counter + ": " +  message.getText());
//                counter++;
//            } else {
//
//            }
